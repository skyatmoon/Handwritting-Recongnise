...
parser.add_argument('--width', default=300, type=int, help="input image width")
...
def val(net, valSet, ctc_loss, max_iter=100):
    ...
    valloss.append(loss_avg / max_iter)
    net.train()
...
if __name__ == '__main__':
    ...
    #                     target_size=(args.width, args.height), characters=args.characters, transform=transform)
    trainSet = IAMDataSet(image_root="/home/skyatmoon/COMP4550/IAM/words/", label_root = "/home/skyatmoon/COMP4550/IAM/words.txt",
                          target_size=(args.width, args.height), characters=args.characters, transform=transform)
    valSet = IAMDataSet(image_root="/home/skyatmoon/COMP4550/IAM/test/", label_root = "/home/skyatmoon/COMP4550/IAM/test.txt",
                        target_size=(args.width, args.height), characters=args.characters, transform=transform)
    train(net, optimizer, trainSet, valSet, use_gpu)


    np.savetxt('valloss',valloss)
    np.savetxt('trainloss', epochloss)
    np.savetxt('enum', epochnum)